--[[
  @description Search Else samples in media explorer that are not drums and randomize list
  @author DemianD
  @version 1.0
  @about
...
MediaSearch('NOT bassdrum NOT kick NOT kik NOT snare NOT snr NOT rim NOT clap NOT hat NOT hh NOT crash NOT splash NOT ride NOT cym')
